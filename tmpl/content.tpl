...
<span></span>
		...
		<div class="afisha">
			...
			echo 'К сожалению, товаров в данной категории пока не представлено ((( Зайдите к нам позже! ';
		...
		<div class='more&all'>
			...
			if ($this->pagenum) 
			{			
				for ($i=1; $i <=count($this->pagenum) ; $i++) 
					{?> 
						<li><a  href="?page=<?=$this->pagenum[$i];?>"><?=$this->pagenum[$i];?></a></li>
					<?}
			}
